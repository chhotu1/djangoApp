...
class SignUp(User):
    mobile_telephone = models.PositiveIntegerField('Mobile',default=0,blank=True, validators=[telephone, MaxLengthValidator])
...
class Team(models.Model):
    ...
    mobile = models.PositiveIntegerField('Mobile', default=0, blank=True,validators=[telephone, MaxLengthValidator])
